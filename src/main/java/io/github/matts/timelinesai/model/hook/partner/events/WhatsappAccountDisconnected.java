...
public class WhatsappAccountDisconnected extends PartnerEvent {
    private Integer user_id;
    private Integer whatsapp_account_id;
    private String phone_number_e164;
    private Instant disconnected_at;
    private String reason;

    @Builder
    public WhatsappAccountDisconnected(String workspace_id, PartnerEvents event_type, String partner_id, Instant triggered_at, Integer user_id, Integer whatsapp_account_id, String phone_number_e164) {
